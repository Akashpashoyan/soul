...
TOKEN = '6741679677:AAFt_IXZ80V-UPKk_-a99ZrUSjHFshsdfy8'
MONGO_URI = 'mongodb+srv://sonurdp:root@cluster0.ta3u2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
FORWARD_CHANNEL_ID = -1002319438105
CHANNEL_ID = -1002319438105
error_channel_id = -1002319438105
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*@Issue_Issue*", parse_mode='Markdown')
    else:
